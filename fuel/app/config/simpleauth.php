...
return array(
	 ...
	 */
	'groups' => array(
		50   => array('name' => 'Editor', 'roles' => array('usuario', 'editor')),
		100  => array('name' => 'Administrador', 'roles' => array('usuario', 'editor', 'admin'))
		/**
		 * Examples
		 * ---
		 *
