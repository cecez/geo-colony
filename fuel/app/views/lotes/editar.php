...
echo Form::open(array('action' => 'lotes/editar', 'enctype' => 'multipart/form-data'));

?>
<input type="hidden" name="id" value="<?php echo $id; ?>" />
<p>
	<label for="form_numero">Número:</label>
	<input type="text" required="required" id="form_numero" name="numero" value="<?php echo $numero; ?>"/>
</p>
...
<p>
	...
	<input type="text" id="form_nucleo" name="nucleo" value="<?php echo $nucleo; ?>"/>
</p>

<p>
	<label for="form_seccao">Secção:</label>
	<input type="text" id="form_seccao" name="seccao" value="<?php echo $seccao; ?>"/>
</p>

<p>
	<label for="form_lado">Lado/Ala:</label>
	<input type="text" id="form_lado" name="lado" value="<?php echo $lado; ?>"/>
</p>
...
<p>
<input type="checkbox" name="notificacao" id="notificacao"/><label for="notificacao">Desejo receber notificações deste lote</label>
</p>
